  ...
  getProjectInfo(): void {
    this.projectFilesService.getProjectInfo({}, true, res => {
      ...
      if (res !== 'error') {
        ...
        this.projectNumber = res.data[1].projectNumber;
        this.constructionNature = res.data[2].constructionNature;
        this.industryType = res.data[3].industryType;
        this.approvalOffice = res.data[4].approvalOffice;
        this.technology = res.data[5].technology;
        this.phone = res.data[6].phone;
      }
    });
  }
